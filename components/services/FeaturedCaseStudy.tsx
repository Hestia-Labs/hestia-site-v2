...
FeaturedCaseStudy({ caseStudy }: FeaturedCaseStudyProps) {
          ...
          <div className="overflow-hidden rounded-sm shadow-md">
            ...
            >
              <Image 
                ...
                className="object-cover transition-all duration-500 grayscale-[30%] hover:grayscale-0"
              />
            </motion.div>
          </div>
